                            ...
                            <div class="col-lg-10 col-sm-9">
                                <div class="timeline-info">
                                    <ul>
                                        ...
                                        <li>
                                            <Link class="active" :href="route('welcome')" title="" data-ripple="">time
                                            line</Link>
                                            <Link class="" :href="route('friends')" title="" data-ripple="">Friends
                                            </Link>
                                            <Link class="" :href="route('users')" title="" data-ripple="">Users
                                            </Link>
                                        ...
                                        <aside class="sidebar static">
                                            ...
                                            <div class="widget friend-list stick-widget">
                                                ...
                                                <ul id="people-list" class="friendz-list">
                                                    <li>
                                                        <figure>
                                                            <img src="/assets/images/resources/friend-avatar.jpg"
                                                                alt="">
                                                            <span class="status f-online"></span>
                                                        </figure>
                                                    ...
                                                    <li>
                                                        <figure>
                                                            <img src="/assets/images/resources/friend-avatar2.jpg"
                                                                alt="">
                                                    ...
                                                    <li>
                                                        <figure>
                                                            <img src="/assets/images/resources/friend-avatar3.jpg"
                                                                alt="">
                                                    ...
                                                    <li>
                                                        <figure>
                                                            <img src="/assets/images/resources/friend-avatar4.jpg"
                                                                alt="">
                                                            <span class="status f-off"></span>
                                                        </figure>
                                                        <div class="friendz-meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <figure>
                                                            <img src="/assets/images/resources/friend-avatar5.jpg"
                                                                alt="">
                                                            <span class="status f-online"></span>
                                                        </figure>
                                                        <div class="friendz-meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <figure>
                                                            <img src="/assets/images/resources/friend-avatar6.jpg"
                                                                alt="">
                                                            <span class="status f-away"></span>
                                                        </figure>
                                                        <div class="friendz-meta">
                                                    ...
                                                    <li>
                                                        ...
                                                        <figure>
                                                            <img src="/assets/images/resources/friend-avatar7.jpg"
                                                                alt="">
                                                            <span class="status f-off"></span>
                                                        </figure>
                                                        <div class="friendz-meta">
